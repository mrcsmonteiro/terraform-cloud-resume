...
resource "aws_s3_bucket_ownership_controls" "cloudfront_logs_bucket_ownership_controls" {
...
resource "aws_s3_bucket_acl" "cloudfront_logs_acl" {
  depends_on = [aws_s3_bucket_ownership_controls.cloudfront_logs_bucket_ownership_controls]
  bucket     = aws_s3_bucket.cloudfront_logs_bucket.id
